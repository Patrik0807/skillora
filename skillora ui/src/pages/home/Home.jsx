...
function Home() {
  return (
    <div className="home">
      ...
      {/* ✅ Explore the Marketplace Section with Links */}
      <div className="explore">
        <div className="container">
          <h1>Explore the marketplace</h1>
          <div className="items">
            <Link to="/gigs?cat=design" className="item">
            ...
            <Link to="/gigs?cat=marketing" className="item">
            ...
            <Link to="/gigs?cat=writing" className="item">
            ...
            <Link to="/gigs?cat=animation" className="item">
            ...
            <Link to="/gigs?cat=music" className="item">
            ...
            <Link to="/gigs?cat=programming" className="item">
      ...
      <div className="features dark">
        <div className="container">
          <div className="item">
            ...
            <button>Explore Skillora Business</button>
          </div>
          <div className="item">
